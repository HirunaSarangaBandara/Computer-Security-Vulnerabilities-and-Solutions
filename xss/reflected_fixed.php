...
<html>
<head>
    <title>Fixed Reflected XSS</title>
    <style>
        ...
        .message-output { border: 1px solid #00c000; padding: 10px; background-color: #e6ffe6; border-radius: 5px; margin-bottom: 15px; }
...
<body>
    <div class="container">
        <h2>Reflected XSS (Fixed with htmlentities)</h2>
        <p>Access the URL with the malicious query. It should display the script tag as text.</p>
        
        <h3>Search Results</h3>
        <?php if ($search_query): ?>
            <div class="message-output">
                <p>You searched for: <strong><?= htmlentities($search_query) ?></strong></p> 
            </div>
        <?php endif; ?>
